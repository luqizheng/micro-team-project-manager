...
export class AttachmentsController {
  ...
  presign(@Body() body: { key: string; contentType: string }) {
    ...
    return this.svc.createPresignedPost({ bucket, key: body.key, contentType: body.contentType });
  }
  ...
  record(
    ...
    @Body() body: { objectKey: string; fileName: string; size: number; contentType: string },
  ) {
